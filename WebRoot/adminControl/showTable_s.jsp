...
function star()
{
	if (document.getElementById("shyj").value == "") {
		window.alert("请填写审核意见！");		
		document.getElementById("shyj").focus();
		return false;
	}	
}
</script>
...
<body>
<form action="modifyXSDemand.action" method="post" name="collectform" onsubmit = "return star();">
...
<table border="1" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3"><select name="demand.fpbm">  
  ...
  <tr>
	...
	<td colspan="4" >
		<input type=radio name="demand.xsstate" id="xsstate" value="1">同意 &nbsp; &nbsp;
		<input type="radio" name="demand.xsstate" id="xsstate" value="0" />不同意
	</td>
  </tr>
  <tr align="center">
  <td colspan="4">
